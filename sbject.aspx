<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="sbject.aspx.cs" Inherits="sbject" %>
...
&nbsp;
                ...
                <table style="padding: 4px; margin: 4px; width: 1043px; background-color: #660066; height: 198px;">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF">SUBJECT&#39;S PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 225px">
                            <asp:TextBox ID="txtSbjname" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>

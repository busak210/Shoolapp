<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="term.aspx.cs" Inherits="term" %>
...
&nbsp;
                ...
                <table style="padding: 4px; margin: 4px; width: 1043px; background-color: #660066; height: 198px;">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF">TERM&#39;S PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 124px; text-align: right">
                            <asp:Label ID="Label14" runat="server" CssClass="bold" style="color: #FFFFFF" Text="Term Name : "></asp:Label>
                        </td>
                        <td style="width: 225px">
                            <asp:TextBox ID="txttermname" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>

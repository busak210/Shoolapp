<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="clss.aspx.cs" Inherits="clss" %>
...
&nbsp;
                ...
                <table style="padding: 4px; margin: 4px; width: 1043px; background-color: #660066; height: 355px;">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF">CLASS&#39;S PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 124px; text-align: right">
                            <asp:Label ID="Label14" runat="server" CssClass="bold" style="color: #FFFFFF" Text="Class  : "></asp:Label>
                        </td>
                        <td style="width: 225px">
                            <asp:TextBox ID="txtclass" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 124px; text-align: right">
                            <asp:Label ID="Label16" runat="server" CssClass="bold" style="color: #FFFFFF" Text="Arm  : "></asp:Label>
                        </td>
                        <td style="width: 225px">
                            <asp:TextBox ID="txtarm" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 124px" class="text-right">
                            <asp:Label ID="Label13" runat="server" CssClass="bold" style="color: #FFFFFF" Text="Category : "></asp:Label>
                        </td>
                        <td colspan="5">
                            <asp:DropDownList ID="dplCat" runat="server" Height="23px" Width="180px" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="CatName" DataValueField="CatName">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:schoolsConnectionString %>" SelectCommand="SELECT DISTINCT [CatName] FROM [ClassCategory] WHERE ([Schid] = @Schid) ORDER BY [CatName]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="Label3" Name="Schid" PropertyName="Text" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>

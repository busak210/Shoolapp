...
public partial class sbject : System.Web.UI.Page
{
    Connect c;
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            c = new Connect();
            c.shola();
            c.com.CommandText = "spSubjectCreate @subjectname, @Shlid ";
            c.com.Parameters.Add(new SqlParameter("@Shlid", Label3.Text));
            c.com.Parameters.Add(new SqlParameter("@subjectname", txtSbjname.Text));

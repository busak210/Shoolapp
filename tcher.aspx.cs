...
public partial class tcher : System.Web.UI.Page
{
    Connect c;
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            c = new Connect();
            c.shola();
            c.com.CommandText = "spTeacherCreate  @name,@username,@password,@cat,@Shlid";
            c.com.Parameters.Add(new SqlParameter("@Shlid", Label3.Text));
            c.com.Parameters.Add(new SqlParameter("@name", txtname.Text));
            c.com.Parameters.Add(new SqlParameter("@username", txtusername.Text));
            c.com.Parameters.Add(new SqlParameter("@password", txtpwd.Text));
            c.com.Parameters.Add(new SqlParameter("@cat", dplCat.Text.ToString()));

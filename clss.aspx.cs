...
public partial class clss : System.Web.UI.Page
{
    Connect c;
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            c = new Connect();
            c.shola();
            c.com.CommandText = "spClassCreate @class,@arm,@cat, @Shlid ";
            c.com.Parameters.Add(new SqlParameter("@Shlid", Label3.Text));
            c.com.Parameters.Add(new SqlParameter("@class", txtclass.Text));
            c.com.Parameters.Add(new SqlParameter("@arm", txtarm.Text));

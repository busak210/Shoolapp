<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="compute.aspx.cs" Inherits="compute" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table style="padding: 4px; margin: 4px; width: 1043px; background-color: #660066; height: 279px;">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF">COMPILATION PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 124px; text-align: right; height: 63px;">
                            <asp:Label ID="Label14" runat="server" CssClass="bold" style="color: #FFFFFF" Text="Subject Name : "></asp:Label>
                        </td>
                        <td style="height: 63px">
                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="subjectname" DataValueField="subjectname" Height="30px" Width="271px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:schoolsConnectionString %>" SelectCommand="SELECT DISTINCT [subjectname] FROM [TeacherSubject-Class] WHERE (([StaffName] = @StaffName) AND ([Term] = @Term) AND ([Sessn] = @Sessn)) ORDER BY [subjectname]">
                                <SelectParameters>
                    ...
                    <tr>
                        ...
                        <td style="height: 63px">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:schoolsConnectionString %>" SelectCommand="SELECT DISTINCT [Class] FROM [TeacherSubject-Class] WHERE (([StaffName] = @StaffName) AND ([subjectname] = @subjectname) AND ([Sessn] = @Sessn) AND ([Term] = @Term)) ORDER BY [Class]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="Label2" Name="StaffName" PropertyName="Text" Type="String" />
                                    <asp:ControlParameter ControlID="DropDownList1" Name="subjectname" PropertyName="SelectedValue" Type="String" />
                                    <asp:ControlParameter ControlID="Label4" Name="Sessn" PropertyName="Text" Type="String" />
                                    <asp:ControlParameter ControlID="Label5" Name="Term" PropertyName="Text" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                    ...
                    <tr>
                        ...
                        <td style="height: 63px">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:schoolsConnectionString %>" SelectCommand="SELECT DISTINCT [Arm] FROM [TeacherSubject-Class] WHERE (([subjectname] = @subjectname) AND ([Class] = @Class) AND ([StaffName] = @StaffName) AND ([Sessn] = @Sessn) AND ([Term] = @Term)) ORDER BY [Arm]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="DropDownList1" Name="subjectname" PropertyName="SelectedValue" Type="String" />
                    ...
                    <tr>
                        <td style="width: 124px">&nbsp;</td>
                        <td colspan="5">
                            <asp:Button ID="btnok" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Medium" Height="42px"  Text="Compute" Width="106px" OnClick="btnok_Click"  />
                            </td>
                    </tr>
          ...
          <Columns>
              ...
              <asp:TemplateField  HeaderText="Student Names">
                  <ItemTemplate>
                       <asp:Label  ID="txtstdName" runat="server" Text='<%#Eval("[StudentName]")%>' Enabled="false"></asp:Label>
                  </ItemTemplate>
              </asp:TemplateField>
            
              <asp:TemplateField HeaderText="Reg. Number">
                  <ItemTemplate >
                      <asp:Label ID="txtstdreg" runat="server" Text='<%#Eval("[RegNo]")%>' Enabled="false"></asp:Label>
                  </ItemTemplate>
              </asp:TemplateField>
               <asp:TemplateField  HeaderText="Assessment">
                  <ItemTemplate>
                      <asp:TextBox ID="txtstdca" runat="server" Text='<%#Eval("[CA]")%>' Enabled="true" Width="120px"></asp:TextBox>
                  </ItemTemplate>
              </asp:TemplateField>
               <asp:TemplateField  HeaderText="Examination">
                  <ItemTemplate>
                      <asp:TextBox ID="txtstdexam" runat="server" Text='<%#Eval("[Exams]")%>' Enabled="true" Width="120px"></asp:TextBox>
                  </ItemTemplate>
              </asp:TemplateField>
                    ...
                    <tr>
                        <td style="width: 124px">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:schoolsConnectionString %>" SelectCommand="SELECT DISTINCT [id] FROM [TeacherSubject-Class] WHERE (([subjectname] = @subjectname) AND ([schlid] = @schlid) AND ([Term] = @Term) AND ([Sessn] = @Sessn) AND ([Class] = @Class) AND ([Arm] = @Arm))">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="DropDownList1" Name="subjectname" PropertyName="SelectedValue" Type="String" />

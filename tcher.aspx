<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="tcher.aspx.cs" Inherits="tcher" %>
...
&nbsp;
                ...
                <table style="padding: 4px; margin: 4px; width: 1043px; background-color: #660066; height: 355px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 225px">
                            <asp:TextBox ID="txtpwd" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <asp:DropDownList ID="dplCat" runat="server" Height="22px" Width="115px" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="catName" DataValueField="catName">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:schoolsConnectionString %>" SelectCommand="SELECT [catName] FROM [UserCategory] ORDER BY [catName]"></asp:SqlDataSource>
                        </td>
                    </tr>
